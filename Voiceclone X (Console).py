...
def main():
    ...
    proceed = input("Do you want to change Command Prompt Execution Policy? (Y/N): ").strip().lower()
    if proceed != 'y':
    ...
    if current_policy == "RemoteSigned":
        reset_input = input("The current policy is 'RemoteSigned'. Do you want to reset the execution policy to the default 'Restricted'? (Y/N): ").strip().lower()
        if reset_input == 'y':
            ...
            reset_back_input = input("Do you want to change the execution policy back to 'RemoteSigned'? (Y/N): ").strip().lower()
        ...
        user_input = input("Do you want to change the execution policy to 'RemoteSigned'? (Y/N): ").strip().lower()
        if user_input == 'y':
